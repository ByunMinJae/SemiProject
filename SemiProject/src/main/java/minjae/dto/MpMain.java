...
public class MpMain {
	...
	public MpMain(int userno, String userid, String userpw, String username, String gender, String address,
	...
	public String toString() {
		return "MpMain [userno=" + userno + ", userid=" + userid + ", userpw=" + userpw + ", username=" + username
