...
public class Paging2 {
	...
	public Paging2(int totalCount, int curPage) {
	...
	public Paging2(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	private void makePaging() {
		...
		if(listCount == 0)		setListCount(2); //화면에 보여질 게시글 수를 10개로 기본 설정한다
