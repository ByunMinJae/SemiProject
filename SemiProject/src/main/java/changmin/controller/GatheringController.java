...
@WebServlet("/board/gathering")
public class GatheringController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("/board/gathering [GET]");

		//----------------------게시글 전체 조회-------------------------------

		Category category = new Category();
		category.setCategoryno(4);
		...
		req.getRequestDispatcher("/WEB-INF/views/changmin/gathering.jsp").forward(req, resp);
